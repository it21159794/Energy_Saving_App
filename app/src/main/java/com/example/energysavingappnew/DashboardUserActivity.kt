...
//        }
        ...
        binding.locationRvUser.setOnClickListener{
    ...
    private fun loadLocations() {
        ...
        ref.addValueEventListener(object : ValueEventListener{
            override fun onDataChange(snapshot: DataSnapshot){
                ...
                //setup adapter
                adapterLocation = AdapterLocation(this@DashboardUserActivity, locationArrayList)
                //set adapter to recyclerview
                binding.locationRvUser.adapter = adapterLocation
            }
